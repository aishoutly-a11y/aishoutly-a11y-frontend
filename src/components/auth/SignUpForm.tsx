      ...
      <div className="w-full max-w-[480px] z-10">
        ...
        <div className="bg-white rounded-[32px] p-8 sm:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100">
          ...
          <p className="mt-6 text-center text-xs text-gray-400 leading-relaxed px-4">
            By creating an account, you agree to our <Link href="/terms" className="underline font-bold text-gray-500">Terms</Link> and <Link href="/privacy" className="underline font-bold text-gray-500">Privacy Policy</Link>
          </p>
        </div>
